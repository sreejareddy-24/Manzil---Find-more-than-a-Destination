        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: 1 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            {isEditingHotel ? (
              ...
              <span
                style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '4px', display: 'block', cursor: 'pointer' }}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          {totalActivities > 0 && (
            <div style={{ textAlign: 'right', minWidth: '70px' }}>
              ...
              <div style={{ width: '70px', height: '4px', background: 'rgba(255,255,255,0.05)', borderRadius: '2px', overflow: 'hidden' }}>
                <div style={{ width: `${progressPct}%`, height: '100%', background: 'var(--success)', borderRadius: '2px', transition: 'width 0.3s ease' }} />
              </div>
            </div>
          )}

          <div style={{ textAlign: 'right' }}>
            <span style={{ fontSize: '0.78rem', color: 'var(--text-secondary)', textTransform: 'uppercase' }}>Est. Cost</span>
